...
class TestService:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (AnimeSchema(id=4, title="TestTitle", status=AnimeStatus.completed, genres=["TestGenre", "another genres"], description="Just description"),
             does_not_raise()),
            (AnimeSchema(id=2, title='Naruto', status=AnimeStatus.completed, genres=['senen', 'also genres'], description="Just description"),
             does_not_raise()),
            (AnimeSchema(id=5, title="TestTitle", status=AnimeStatus.completed, genres=["TestGenre", "another genres"], description="Just description"),
             pytest.raises(IndexError)),
            (AnimeSchema(id=0, title="TestTitle", status=AnimeStatus.completed, genres=["TestGenre", "another genres"], description="Just description"),
             pytest.raises(IndexError)),
